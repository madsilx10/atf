"""
ATF Miners Bot - Multi Account  v1.3.5
...
def main():
    ...
    # Pilih mode
    mode_idx = prompt("Mode:", ["Full (wallet + task + mining)", "Mining aja", "Task aja", "Wallet + Mining", "Claim aja", "Disconnect Wallet"])
    mode     = ["full", "mining", "task", "wallet_mining", "claim", "disconnect_wallet"][mode_idx]
