...
class ATFSession:
    ...
    def do_task(self, task_id: str):
        ...
        if r_start.get("status") not in ("success", "already_started"):
            ...
            return r_start
        print(f"    task {task_id}: tunggu 30 detik sebelum claim...")
        time.sleep(30)
...
def main():
    ...
    # Pilih mode
    mode_idx = prompt("Mode:", ["Full (wallet + task + mining)", "Mining aja", "Task aja", "Wallet + Mining"])
    mode     = ["full", "mining", "task", "wallet_mining"][mode_idx]
